...
var convert = __webpack_require__(83).convert;
var bodyStream = __webpack_require__(103);
...
__webpack_require__(115).inherits(FetchError, Error);
...
var main = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
    var downloadURL, responseLatest, latest, name, asset, url, resp, size, ws;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _fs2.default.writeFileSync(now, '#!/usr/bin/env node\n' + 'console.log("Please wait until \'now\' installation completes!")\n');
            ...
            (0, _log.info)('Retrieving the latest CLI version...');

            downloadURL = 'https://api.github.com/repos/zeit/now-cli/releases/tags/' + packageJSON.version;
            _context.next = 6;
            return (0, _nodeFetch2.default)(downloadURL);

          case 6:
            responseLatest = _context.sent;
            _context.next = 9;
            return responseLatest.json();

          case 9:
            latest = _context.sent;
            name = platformToName[process.platform];
            asset = latest.assets.find(function (a) {
              return a.name === name;
            });


            (0, _log.info)('For the sources, check out: https://github.com/zeit/now-cli');

            // Print an empty line
            console.log('');

            (0, _log.enableProgress)('Downloading now CLI ' + packageJSON.version);
            (0, _log.showProgress)(0);
          ...
          case 19:
            ...
            (0, _log.disableProgress)();
            throw new Error(resp.statusText + ' ' + url);

          case 23:
            size = resp.headers.get('content-length');
            ws = _fs2.default.createWriteStream(partial);
            _context.next = 27;
            return new _promise2.default(function (resolve, reject) {
              ...
              resp.body.on('data', function (chunk) {
                ...
                (0, _log.showProgress)(100 * bytesRead / size);
              });

              resp.body.pipe(ws);

              ws.on('close', function () {
                (0, _log.showProgress)(100);
                (0, _log.disableProgress)();
                resolve();
...
var _path = __webpack_require__(113);

var _path2 = _interopRequireDefault(_path);

var _death = __webpack_require__(81);
...
var _chmod = __webpack_require__(44);

var _chmod2 = _interopRequireDefault(_chmod);
...
// Native
var now = _path2.default.join(__dirname, 'now');
var targetWin32 = _path2.default.join(__dirname, 'now.exe');
var target = process.platform === 'win32' ? targetWin32 : now;
var partial = target + '.partial';

var packagePath = _path2.default.join(__dirname, '..', '..', 'package.json');
var packageJSON = JSON.parse(_fs2.default.readFileSync(packagePath, 'utf8'));
...
exports.default = function (file) {
  var s = _fs2.default.statSync(file);
  var newMode = s.mode | 64 | 8 | 1;
  if (s.mode === newMode) return;
  var base8 = newMode.toString(8).slice(-3);
  _fs2.default.chmodSync(file, base8);
};
...
exports.enableProgress = enableProgress;
exports.info = info;
exports.showProgress = showProgress;
exports.disableProgress = disableProgress;

var _assert = __webpack_require__(111);
...
function enableProgress(text) {
  (0, _assert2.default)(!bar);
  // OLD: text += ' '.repeat(28 - text.length);
  bar = new _progress2.default('> ' + text + ' [:bar] :percent', {
...
module.exports = !__webpack_require__(6) && !__webpack_require__(29)(function(){
...
var global    = __webpack_require__(1)
  , macrotask = __webpack_require__(35).set
...
var LIBRARY            = __webpack_require__(32)
  ...
  , task               = __webpack_require__(35).set
...
var iconvLite = __webpack_require__(101);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(21).concat(__webpack_require__(39)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(21).concat(__webpack_require__(39)) },
        gb18030: function() { return __webpack_require__(95) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(38).concat(__webpack_require__(92)) },
...
var StringDecoder = __webpack_require__(114).StringDecoder;
...
var Headers = __webpack_require__(23);
